...
test("운영 상태 질의는 전부 읽기이고 진단 지도의 여섯 질문을 덮는다", () => {
  ...
  for (const table of ["monitoring.violation", "monitoring.round", "monitoring.notification", "ingest.backfill_coverage", "ingest.source_hold", "mart.build"]) {
