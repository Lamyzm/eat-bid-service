/** @module 책임: 짧은 상태 라벨을 텍스트와 함께 전달하는 공통 Badge 표면의 시각 variant를 소유한다. */
...
// canonical UI는 전환할 속성을 적는다. badge가 실제로 바꾸는 것은 색·배경·테두리와 focus ring뿐이고,
// `transition-all`은 layout 속성까지 함께 애니메이션해 목록이 길어질 때 비용이 눈에 띈다.
