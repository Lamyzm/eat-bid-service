/** @module 책임: 분석 resource의 404 Problem을 화면이 다룰 수 있는 의미로 변환한다. */
...
export function isAnalysisCohortNotFoundError(error: unknown): error is AnalysisCohortNotFoundError {
