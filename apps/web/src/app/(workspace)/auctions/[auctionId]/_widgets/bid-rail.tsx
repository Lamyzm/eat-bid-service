...
import { type BidRateStep, bidAmount, formatWon, parseBidRate, stepBidRate } from '../_lib/bid-rate';
import type { DecisionPresentation } from '../_lib/present-decision';
import { NO_RATE_PHRASE } from '../_features/rehearsal/model/verdict-vocabulary';
