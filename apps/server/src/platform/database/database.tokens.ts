...
export const OPEN_AUCTION_SUMMARY_READER = Symbol("OPEN_AUCTION_SUMMARY_READER");
export const ELIGIBILITY_AREA_READER = Symbol("ELIGIBILITY_AREA_READER");
...
export const ANALYSIS_TIME_SERIES_READER = Symbol("ANALYSIS_TIME_SERIES_READER");
export const ANALYSIS_CONDITION_OPTIONS_READER = Symbol("ANALYSIS_CONDITION_OPTIONS_READER");
