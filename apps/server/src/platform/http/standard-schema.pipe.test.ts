...
describe("Standard Schema request and response boundaries", () => {
  test("request validation rejects an invalid value", async () => {
  ...
  test("response validation fails closed instead of leaking an extra field", async () => {
