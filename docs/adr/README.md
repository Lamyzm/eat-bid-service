...
| [0037](0037-additive-ingestion-fields-and-parser-version.md) | Accepted | 봉인된 수집 계약의 optional 가산 확장(`exclude_unset` canonical 재직렬화), `location.eligibilityAreas`, 라벨을 싣는 파서는 새 version `eat-v3` (0014·0025·0029 refine) |
