...
Drizzle 마이그레이션 `20260917095650_announcement_change_kind_snapshot`의 snapshot에서 만든 표·컬럼·외래키 그림이다. 표 8개.
...
erDiagram
    ...
    open_auction_snapshot {
        ...
        bigint announcement_change_kind_code_value_id FK
    ...
    core__code_value ||--o{ open_auction_snapshot : "announcement_change_kind_code_value_id"
