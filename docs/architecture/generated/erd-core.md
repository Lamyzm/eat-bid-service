...
Drizzle 마이그레이션 `20260917154955_org_round_summary_region`의 snapshot에서 만든 표·컬럼·외래키 그림이다. 표 18개.
...
erDiagram
    ...
    code_value ||--o{ mart__org_round_summary : "region_sido_code_value_id"
    code_value ||--o{ mart__org_round_summary : "region_sigungu_code_value_id"
