<!-- 생성물이다. 직접 편집하지 않고 `pnpm architecture:erd:write`로 다시 만든다. 원천: packages/db/drizzle/20260917095650_announcement_change_kind_snapshot/snapshot.json -->
# `core` 스키마 ERD

Drizzle 마이그레이션 `20260917095650_announcement_change_kind_snapshot`의 snapshot에서 만든 표·컬럼·외래키 그림이다. 표 18개.
...
erDiagram
    ...
    code_value ||--o{ app__workspace_filter_combination_item : "item_code_value_id"
    ...
    code_value ||--o{ mart__open_auction_snapshot : "announcement_change_kind_code_value_id"
    ...
    code_value ||--o{ mart__open_auction_snapshot : "solo_bid_method_code_value_id"
    code_value ||--o{ mart__open_auction_snapshot : "source_status_code_value_id"
    code_value ||--o{ mart__open_auction_snapshot_item : "item_code_value_id"
    code_value ||--o{ mart__org_round_summary : "award_method_code_value_id"
    code_value ||--o{ mart__org_round_summary_item : "item_code_value_id"
