...
ALTER TABLE "core"."code_release_member" ADD CONSTRAINT "code_release_member_parent_fkey" FOREIGN KEY ("code_release_id","parent_code_value_id") REFERENCES "core"."code_release_member"("code_release_id","code_value_id");